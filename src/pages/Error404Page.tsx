    ...
    return (
        <>
            ...
            <div className="flex justify-center items-center w-screen h-screen">
                    ...
                    <Link to={'/home'} className="flex justify-center items-center fixed top-[75%] left-[50%] -translate-x-1/2 w-[216px] h-[46px] bg-accent rounded-[10px] text-stone01 text-[20px] font-[600]">
                        กลับสู่หน้าหลัก
                    </Link>
            </div>
        </>
