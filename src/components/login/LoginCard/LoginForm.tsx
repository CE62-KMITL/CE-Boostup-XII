...
function LoginForm() {
    ...
    const eyeIcon = () => {
        if (passwordAppearance) {
            return (
                <div className="border-none border-rose-500 flex justify-center items-center relative w-full h-full">
                    <svg className="absolute" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.625 4C0.625 3.10489 0.98058 2.24645 1.61351 1.61351C2.24645 0.98058 3.10489 0.625 4 0.625C4.89511 0.625 5.75355 0.98058 6.38649 1.61351C7.01942 2.24645 7.375 3.10489 7.375 4C7.375 4.89511 7.01942 5.75355 6.38649 6.38649C5.75355 7.01942 4.89511 7.375 4 7.375C3.10489 7.375 2.24645 7.01942 1.61351 6.38649C0.98058 5.75355 0.625 4.89511 0.625 4Z" fill="#495057"/>
                    </svg>
                    <svg className="absolute" width="30" height="24" viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0 12C0 14.46 0.6375 15.2865 1.9125 16.944C4.458 20.25 8.727 24 15 24C21.273 24 25.542 20.25 28.0875 16.944C29.3625 15.288 30 14.4585 30 12C30 9.54 29.3625 8.7135 28.0875 7.056C25.542 3.75 21.273 0 15 0C8.727 0 4.458 3.75 1.9125 7.056C0.6375 8.715 0 9.5415 0 12ZM15 6.375C13.5082 6.375 12.0774 6.96763 11.0225 8.02252C9.96763 9.07742 9.375 10.5082 9.375 12C9.375 13.4918 9.96763 14.9226 11.0225 15.9775C12.0774 17.0324 13.5082 17.625 15 17.625C16.4918 17.625 17.9226 17.0324 18.9775 15.9775C20.0324 14.9226 20.625 13.4918 20.625 12C20.625 10.5082 20.0324 9.07742 18.9775 8.02252C17.9226 6.96763 16.4918 6.375 15 6.375Z" fill="#495057"/>
                    </svg>
                </div>
            )
        } else {
    ...
    return (
        <div className="absolute bottom-0 w-full h-[90%] min-h-[400px] max-h-[450px] p-[30px]">
            <form action="" className="flex flex-col items-center place-content-between w-full h-full">
                <div className="flex flex-col items-center place-content-between w-full h-[75%]">
                    ...
                    <div className="flex items-center place-content-between w-[96%]">
                        <div className="flex items-center place-content-between h-full">
                            <input type="checkbox" className="scale-[0.66]" placeholder="_"/>
                ...
                <Button type={2} mode={0} validate={true} text="ตกลง" img="" link ="https://google.com/"/>
