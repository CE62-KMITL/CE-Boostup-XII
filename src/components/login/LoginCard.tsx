...
function LoginCard() {
    return (
        <div className="w-[482px] h-[704px] relative AbsoluteCentre">
            <div className="absolute translate-x-[-50%] top-0 left-1/2 z-10">
                <LogoIcon />
            </div>
            <div 
            className="w-full h-[527px] bg-slate-600
            absolute translate-x-[-50%] bottom-0 left-1/2 z-0">
                <div className="bg-stone01 w-[128px] h-full 
                ...
                <div className="bg-stone01 w-full h-[464px] rounded-[20px] absolute left-0 bottom-0"></div>
