...
export default function TitleCard ({ title = "โจทย์ปัญหา", difficulty = 0, userSolvedCount = 0 }: TitleCardProps) {
    ...
    return (
        <div className="flex flex-col justify-evenly items-center w-full h-[120px] rounded-[10px] bg-jenna">
            <h2 className="text-2xl font-bold">{title}</h2>
            <div className="flex justify-between w-full px-[30px] text-[16px] font-medium">
