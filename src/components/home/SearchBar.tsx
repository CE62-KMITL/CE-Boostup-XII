        ...
        w-full h-[6%] min-h-[40px] max-h-[45px] mb-[2rem]">
            <div className="w-[60%] h-full">
                <div className="relative w-full h-full">
                    <input type="text" className="absolute w-full h-full rounded-md px-[0.6rem] focus:outline-none" placeholder="พิมพ์ชื่อโจทย์ หรือเลขข้อ"/>
                    <button className="absolute right-0 
                    w-[20%] min-w-[125px] max-w-[100px] h-full rounded-r-md bg-cream" >ค้นหา</button>
                </div>
            </div>

            <div className="flex items-center place-cont</svg>ent-between gap-[0.8rem] w-[40%] h-full">
                
                <div className="relative w-[30%] h-full">
                    <select className="selector-bar absolute w-full h-full rounded-md px-[0.5rem] focus:outline-none" name="lesson" id="lesson">
                    ...
                    <div className="flex justify-center items-center absolute right-0 w-[10%] h-full min-w-[42px] max-w-[48px] rounded-md bg-cream cursor-pointer pointer-events-none">
