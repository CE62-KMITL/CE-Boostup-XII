...
function UserInfo({ username, email, house }: {
    ...
    return (
        <>
            <div className="flex">
                <div className="text-[32px] font-bold text-nowrap max-w-[250px] truncate">{username}</div>
                <div className="text-[16px] ml-[15px] mt-[16px] text-stone04">{email}</div>
                <button onClick={() => setComponents(1)} className="flex self-center items-center bg-accent  hover:bg-accent2 w-[149px] h-[42px] ml-[118px] rounded-lg drop-shadow-md">
