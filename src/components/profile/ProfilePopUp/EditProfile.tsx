            ...
            xl:w-[480px] 2xl:w-[500px] xl:h-[575px] 2xl:h-[550px] xl:p-[36px_33px] 2xl:p-[30px_24px] rounded-[30px] bg-stone01">
                ...
                <div className="w-full h-fit">
                    ...
                    <div className="flex items-center place-content-between w-full h-fit my-[1rem]">
                        ...
                        <button className="w-[136px] h-[48px] border-accent border-[1px] shadow-[0_0_5px] shadow-accent rounded-[10px] text-accent text-[18px] font-bold">เปลี่ยนรหัส</button>
                    </div>

                </div>
                <button className="p-[8px_68px] rounded-[10px] bg-accent text-stone01 text-[18px] font-bold">บันทึก</button>        
            </div>
        </div>
    )
};