...
function LessonCard({ title, description, img }: { title: string; description: string; img: string }) {
    return (
        <div>
            <button className="bg-stone01 w-[256px] h-[340px] border-1 rounded-lg flex flex-col hover:transform hover:translate-y-[-10px] hover:transition hover:duration-300 transition transform translate-y-0 duration-300">
